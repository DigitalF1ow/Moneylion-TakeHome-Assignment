...
function countingFunc()
{
    ...
    */
    ...
    for (count = 0; count < countColor.length; count++) 
    {
        box.insertAdjacentHTML("beforeend", "<p>Color Name: " + countColor[count].colorName + "</p>");
        box.insertAdjacentHTML("beforeend", "<p>Number of Counts: " + countColor[count].numCount + "</p>");
        box.insertAdjacentHTML("beforeend", "<p>List of People Having The Color: " + countColor[count].personColor + "</p><br>");
